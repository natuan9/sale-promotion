...
This module add discount to each applicable sales order line and add
savings amount to the quotation, sales order, and invoice when a
discount code is added to the sales order.
...
errors and audit issues. This update would apply the discount to each
applicable line item to be displayed in the discount percentage (Disc.
%) column instead of adding a single discount line item to the order.
...
.. |maintainer-trobz| image:: https://github.com/trobz.png?size=40px
    :target: https://github.com/trobz
    :alt: trobz
